...
void dht11_task(void* param)
{
    ...
    while(1)
    {
        ...
        // no err
        if ((STORG_temperature != 0xff && STORG_humidity != 0xff) && wifi_state)
        {
